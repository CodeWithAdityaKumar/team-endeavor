  ...
  return (
    <div ref={sectionRef} className="section2 w-full md:min-h-[100vh] bg-[#16171a] relative overflow-visible md:overflow-hidden">
      ...
      >
        ...
        <div className="button_section w-[88%] md:w-[30%] h-auto md:h-[20%] relative md:absolute md:top-[60%] md:left-[10%] flex flex-col md:flex-row gap-4 md:gap-0 items-stretch md:items-center justify-between mt-6 md:mt-0 pl-[6%] md:pl-0">
          <div className="btn_1 w-full md:w-[48%] min-h-[90px] md:h-full flex flex-col md:flex-row items-start md:items-center gap-2 relative">
            ...
            <h2 className="text-white text-[16px] md:text-[18px] mt-2 md:mt-0 md:absolute md:left-[35%] md:top-[22%] w-[90%]">180g miesa</h2>
            <p className="text-gray-400 w-[95%] text-[12px] md:text-[12px] md:absolute md:left-[35%] md:bottom-[12%]">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
          </div>
          <div className="btn_1 w-full md:w-[48%] min-h-[90px] md:h-full flex flex-col md:flex-row items-start md:items-center gap-2 relative">
            ...
            <h2 className="text-white text-[16px] md:text-[18px] mt-2 md:mt-0 md:absolute md:left-[35%] md:top-[22%] w-[90%]">Swieze skfadniki</h2>
            <p className="text-gray-400 w-[95%] text-[12px] md:text-[12px] md:absolute md:left-[35%] md:bottom-[12%]">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
          </div>
        </div>
