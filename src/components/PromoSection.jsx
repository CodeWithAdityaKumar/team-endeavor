    ...
    <div ref={sectionRef} className="section2 w-full min-h-[100vh] bg-[#16171a] relative overflow-visible md:overflow-hidden">
      ...
      >
        <div className="heading_text">
          ...
          <h1 className="text-white text-[10vw] md:text-[66px] w-[80%] md:w-[20%] leading-[60px] md:leading-[70px] relative md:absolute md:left-[10%] md:top-[25%] pl-[6%] mt-2 md:pl-0">
            Wypasionych satatek
          </h1>
        </div>

        <div className="button_section w-[88%] md:w-[30%] h-auto md:h-[20%] relative md:absolute md:top-[60%] md:left-[10%] flex flex-col md:flex-row gap-4 md:gap-0 items-center justify-between mt-6 md:mt-0 pl-[6%] md:pl-0">
          <div className="btn_1 w-full md:w-[48%] h-[90px] md:h-full flex items-center relative">
            <i className="fa-solid fa-fish-fins text-white text-[32px] w-[70px] h-[70px] rounded-[50px] bg-[linear-gradient(90deg,rgba(0,0,0,0)_-34%,rgba(255,0,47,1)_0%,rgba(198,0,36,1)_100%)] shadow-icon flex items-center justify-center"></i>
            <h2 className="text-white text-[16px] md:text-[18px] absolute left-[35%] top-[22%] w-[80%]">180g miesa</h2>
            <p className="text-gray-400 w-[80%] text-[12px] absolute left-[35%] bottom-[12%]">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
          </div>
          <div className="btn_1 w-full md:w-[48%] h-[90px] md:h-full flex items-center relative">
            <i className="fa-solid fa-carrot text-white text-[32px] w-[70px] h-[70px] rounded-[50px] bg-[linear-gradient(90deg,rgba(0,0,0,0)_-34%,rgba(255,0,47,1)_0%,rgba(198,0,36,1)_100%)] shadow-icon flex items-center justify-center"></i>
            <h2 className="text-white text-[16px] md:text-[18px] absolute left-[35%] top-[22%] w-[80%]">Swieze skfadniki</h2>
            <p className="text-gray-400 w-[80%] text-[12px] absolute left-[35%] bottom-[12%]">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
          </div>
        </div>
