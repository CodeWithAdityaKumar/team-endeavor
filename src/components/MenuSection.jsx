...
export default function MenuSection() {
  ...
  return (
    <div ref={sectionRef} className="section1 w-full min-h-[100svh] md:h-[180vh] bg-[#16171a] px-4 md:px-[100px] relative pt-16 sm:pt-20 md:pt-0">
      ...
      {/* Category buttons */}
      <div className="menu_btn w-full md:w-[55%] h-auto md:h-[80px] md:absolute md:top-[13%] mt-4 md:mt-0 flex flex-wrap gap-3 md:gap-0 md:flex-nowrap items-center justify-start md:justify-between">
